...
const urlList = [
  ...
  `https://${HOST}/case-converter`,
  `https://${HOST}/pig-latin-translator`,
  `https://${HOST}/subscript-generator`,
  `https://${HOST}/binary-code-translator`,
  `https://${HOST}/stacked-text-generator`,
  `https://${HOST}/invisible-text-generator`,
  `https://${HOST}/morse-code-translator`,
  `https://${HOST}/medieval-translator`,
  `https://${HOST}/runic-translator`,
  `https://${HOST}/hieroglyphics-translator`,
  `https://${HOST}/cuneiform-translator`,
  `https://${HOST}/pirate-translator`,
  `https://${HOST}/roman-numeral-converter`,
